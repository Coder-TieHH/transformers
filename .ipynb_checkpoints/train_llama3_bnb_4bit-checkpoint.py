...
model_path = "/root/meta-llama/llama-3-8b-Instruct-bnb-4bit"# 模型路径
...
class Gemma2ForSFT(LlamaPreTrainedModel):
...
# 保存模型
trainer.model.save_pretrained("/root/result/Llama3_bnb_4bit_lmhead")
tokenizer.save_pretrained("/root/result/Llama3_bnb_4bit_lmhead")